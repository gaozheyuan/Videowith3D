...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/magic_path.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/client/magic_path.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/client/</a> &#187; magic_path.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">57</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Magic Path
// ----------
...
exports.files = function(prefix, paths) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!paths) {
<span class="cstat-no" title="statement not covered" >    paths = ['*'];</span>
  ...
  paths.forEach(function(path) {
    ...
    if (sp[sp.length - 1].indexOf('.') &gt; 0) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (tree) {
        return tree.files.sort().forEach(function(file) {
          return files.push(file.split('/').slice(numRootFolders).join('/'));
        });
      } else {
<span class="cstat-no" title="statement not covered" >        return log.error(('! Error: ' + dir + ' directory not found').red);</span>
      }
    }
  });
  return files;
