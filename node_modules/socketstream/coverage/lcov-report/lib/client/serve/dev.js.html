...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/serve/dev.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/client/serve/dev.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/client/serve/</a> &#187; dev.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Serve Assets in Development
// ---------------------------
...
&nbsp;
  function serveCSS(request, response) {
    var thisUrl = url.parse(request.url, true),
        ...
        content;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (params._) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    utils.serve.css(content || '/* unknown module */', response);</span>
  }
&nbsp;
...
&nbsp;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (params._) {
      if (params._.charAt(0) !== '.' &amp;&amp; params._.charAt(0) !== '/') {
        params._ = '/' + params._;
      }
&nbsp;
      // delayed serving JS
    ...
    utils.serve.js(content || <span class="branch-1 cbranch-no" title="branch not covered" >'// unknown module',</span> response);
  }
&nbsp;
