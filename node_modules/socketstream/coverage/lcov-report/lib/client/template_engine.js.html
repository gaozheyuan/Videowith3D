...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">92.77% <small>(77 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">89.09% <small>(49 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">93.33% <small>(14 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">92.77% <small>(77 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
          templates.push(wrapTemplate(output, desc.file, ss.bundler.clientFilePath(desc), opts, engine, prevEngine));
          prevEngine = engine;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          ss.log.clientIssue(client,options,err,desc);</span>
<span class="cstat-no" title="statement not covered" >          return cb('Couldn\'t format ' + desc.file + err.userInfoHTML);</span>
        });
      });
    }
  };
...
// private
&nbsp;
function wrapTemplate(template, pth, logicPath, opts, engine, prevEngine) {
  var output;
  output = [];
&nbsp;
...
&nbsp;
  ...
  output.push(engine.process(template.toString(), logicPath, suggestedId(pth), opts));
  return output.join('');
}
&nbsp;
