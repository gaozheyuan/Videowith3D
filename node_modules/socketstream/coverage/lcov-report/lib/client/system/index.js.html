...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/system/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/client/system/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/client/system/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    if (list[i].name === asset.name) {</span>
...
&nbsp;
  switch (type) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case 'const':</span>
    case 'constant':
