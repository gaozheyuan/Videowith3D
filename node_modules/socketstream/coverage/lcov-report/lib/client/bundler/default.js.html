...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/bundler/default.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">lib/client/bundler/default.js</span></h1>
    <h2>
        Statements: <span class="metric">78.38% <small>(29 / 37)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">64% <small>(16 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">83.33% <small>(5 / 6)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">77.78% <small>(28 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/client/bundler/</a> &#187; default.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Default bundler implementation
'use strict';
&nbsp;
    ...
    ss.bundler.loadFile(entry, opts, null,
      function(output) {
        switch(entry.bundle) {
          ...
          case 'css':
            return cb( client.includes.css? output:<span class="branch-1 cbranch-no" title="branch not covered" >'')</span>;
<span class="branch-2 cbranch-no" title="branch not covered" >          case 'worker':</span>
            //TODO
<span class="cstat-no" title="statement not covered" >            if (opts.compress &amp;&amp; entry.file.indexOf('.min') === -1) {</span>
<span class="cstat-no" title="statement not covered" >              output = ss.bundler.minifyJSFile(output, entry.file);</span>
            }
...
<span class="cstat-no" title="statement not covered" >        ss.log.clientIssue(client,options,err,entry);</span>
<span class="cstat-no" title="statement not covered" >        switch(entry.ext) {</span>
          case 'html':
<span class="cstat-no" title="statement not covered" >            return cb('Couldn\'t format ' + entry.file + err.userInfoHTML);</span>
          case 'css':
<span class="cstat-no" title="statement not covered" >            return cb('/* couldn\'t format ' + entry.file + err.userInfoText+' */');</span>
          default:
<span class="cstat-no" title="statement not covered" >            return cb('// couldn\'t format ' + entry.file + err.userInfoText);</span>
        }
      });
