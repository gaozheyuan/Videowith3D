...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/bundler/proto.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/client/bundler/proto.js</span></h1>
    <h2>
        Statements: <span class="metric">84.35% <small>(97 / 115)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">71.43% <small>(40 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">95.24% <small>(20 / 21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">84.21% <small>(96 / 114)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/client/bundler/</a> &#187; proto.js</div>
</div>
<div class="body">
...
&nbsp;
      ...
      case 'module':
        ...
        break;
&nbsp;
<span class="branch-3 cbranch-no" title="branch not covered" >      case 'start':</span>
<span class="cstat-no" title="statement not covered" >        url += 'mod=start';</span>
...
&nbsp;
    clientFilePath: <span class="fstat-no" title="function not covered" >function(rel) {</span>
<span class="cstat-no" title="statement not covered" >      return ss.bundler.clientFilePath(rel);</span>
    },
&nbsp;
...
&nbsp;
  ...
  function resolveAssetLink(client, type) {
    var defaultPath = '/assets/' + client.name + '/' + client.id + '.' + type,
      ...
      link = pack !== undefined ? (pack.cdn !== undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >pack.cdn[type] </span>: void 0) : <span class="branch-1 cbranch-no" title="branch not covered" >void 0;</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (link) {
<span class="cstat-no" title="statement not covered" >      if (typeof link === 'function') {</span>
...
<span class="cstat-no" title="statement not covered" >        return link(file);</span>
      } else <span class="cstat-no" title="statement not covered" >if (typeof link === 'string') {</span>
<span class="cstat-no" title="statement not covered" >        return link;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        throw new Error('CDN ' + type + ' param must be a Function or String');</span>
      }
    } else {
      return defaultPath;
    }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (pathAry.indexOf('libs') &gt;= 0) { //TODO [code,libs] &amp; options.dirs.libs location
<span class="cstat-no" title="statement not covered" >      return code;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (pathAry.indexOf('entry.js') === -1 &amp;&amp; options &amp;&amp; options.browserifyExcludePaths) {
<span class="cstat-no" title="statement not covered" >      for(var i, p; (p = options.browserifyExcludePaths[i]); ++i) {</span>
<span class="cstat-no" title="statement not covered" >        if ( entry.file.split( p )[0] === '' ) {</span>
<span class="cstat-no" title="statement not covered" >          return code;</span>
        }
      }
    }
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (extPos &gt; -1) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.pathPrefix) {
&nbsp;
        // Ignore any filenames in the path
<span class="cstat-no" title="statement not covered" >        if (opts.pathPrefix.indexOf('.') &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >          var sp = opts.pathPrefix.split('/');</span>
<span class="cstat-no" title="statement not covered" >          sp.pop();</span>
<span class="cstat-no" title="statement not covered" >          opts.pathPrefix = sp.join('/');</span>
        }
<span class="cstat-no" title="statement not covered" >        modPath = '/' + path.substr(opts.pathPrefix.length + 1);</span>
      }
&nbsp;
      //TODO else prefix with '/' or not?
    }
