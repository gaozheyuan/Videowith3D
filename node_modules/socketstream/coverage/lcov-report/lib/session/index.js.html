...
<html lang="en">
<head>
    <title>Code coverage report for lib/session/index.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">lib/session/index.js</span></h1>
    <h2>
        Statements: <span class="metric">60.42% <small>(29 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">25% <small>(4 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">40% <small>(4 / 10)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">60.42% <small>(29 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/session/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    return (sessionStore = nameOrStore === 'redis' ? (RedisStore = require('connect-redis')(expressSession), new RedisStore(options)) : nameOrStore);</span>
  },
...
<span class="cstat-no" title="statement not covered" >  var sessionId;</span>
<span class="cstat-no" title="statement not covered" >  sessionId = uid(24);</span>
<span class="cstat-no" title="statement not covered" >  create(sessionId);</span>
...
&nbsp;
    ...
    session.setUserId = <span class="fstat-no" title="function not covered" >function(userId, cb) {</span>
...
&nbsp;
    ...
    session._bindToSocket = function() {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (session.userId) {
<span class="cstat-no" title="statement not covered" >        subscriptions.user.add(session.userId, socketId);</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if ((session.channels) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >session.channels.length &gt; 0)</span> {
<span class="cstat-no" title="statement not covered" >        session.channel._bindToSocket();</span>
      }
      return this;
    };
    session.save = <span class="fstat-no" title="function not covered" >function(cb) {</span>
