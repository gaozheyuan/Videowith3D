...
<html lang="en">
<head>
    <title>Code coverage report for lib/utils/file.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/utils/file.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/utils/</a> &#187; file.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        found = {dirs: [], files: [] }</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw ('Error: Unable to find or parse SocketStream\'s package.json file');</span>
    }
};
&nbsp;
/**
