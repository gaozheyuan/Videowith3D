...
<html lang="en">
<head>
    <title>Code coverage report for lib/utils/unique_set.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/utils/unique_set.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/utils/</a> &#187; unique_set.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  UniqueSet.prototype.remove = function(key, value) {
    var i;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.data[key] === void 0) {
