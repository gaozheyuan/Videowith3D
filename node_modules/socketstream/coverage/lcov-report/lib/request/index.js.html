...
<html lang="en">
<head>
    <title>Code coverage report for lib/request/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/request/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/request/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Request Responders
// ------------------
...
<span class="cstat-no" title="statement not covered" >            throw new Error('Unable to find the \'' + nameOrModule + '\' Request Responder internally');</span>
          }
        }
      })();
      try {
        ...
        responderName = responders[id] &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >responders[id].name </span>|| '';
